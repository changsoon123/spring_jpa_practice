...
@SpringBootTest
@Transactional //JPA는, INSERT, UPDATE, DELETE시에 트랜잭션을 기준으로 동작하는 경우가 많음.
//기능을 보장받기 위해 웬만하면 트랜잭션 기능을 함께 사용해야 한다.
//나중에 MVC 구조에서 Service 클래스에 어노테이션을 첨부하면 된다.
@Rollback(false)
